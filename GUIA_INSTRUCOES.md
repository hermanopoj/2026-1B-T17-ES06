...
O projeto que você tem como referência usa Reveal.js 5 para apresentações HTML, com um tema visual corporativo da Inteli. Inclui aulas, componentes reutilizáveis (cards, tabelas, timers) e um fluxo de desenvolvimento limpo com Prettier e Husky.
